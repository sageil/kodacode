...
func (WorkflowReviewResultTool) Definition() Definition {
	return Definition{
		...
		Description:         "Record the validated result for a workflow review pass. Use exactly once at the end of a workflow review pass; this tool is the durable review result channel.",
		ProviderDescription: "Record the durable result for a workflow review pass. Call exactly once; do not return JSON in assistant text as the result channel.",
