...
1. **Trigger matching** — keyword overlap between the user's message and skill trigger phrases
2. **File condition matching** — glob patterns checked against files touched in the conversation
3. **Language detection** — file extensions mapped to language names, matched against skill conditions
