...
<Aside type="tip">
If you use Neovim with Mason, any LSP server you've installed through Mason is automatically available to KodaCode — no additional configuration needed. This is the easiest way to add language server support.
</Aside>
