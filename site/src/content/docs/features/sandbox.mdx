...
Agent tool access (`allow_tools`/`disallow_tools` in agent frontmatter) is a separate layer that controls which tools an agent is offered at all. It runs before this flow and is covered in the [Agents](/features/agents/) documentation.
