...
KodaCode runs on macOS and Linux. Windows users should install [WSL](https://learn.microsoft.com/en-us/windows/wsl/install) and then follow the Linux installation instructions above.
